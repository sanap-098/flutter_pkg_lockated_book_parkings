...
class ViRevampedColors extends CompanyColors {
  @override
  ...
  @override
  Color get cardLinearGradientEndColor => const Color(0xFFFDAB3D);

  @override
  Color get cardLinearGradientStartColor => const Color(0xFFED323D);
  ...
  Color get carouselSeekBarTrackColor =>
      const Color(0xFFFFC6B8).withValues(alpha: .5);
