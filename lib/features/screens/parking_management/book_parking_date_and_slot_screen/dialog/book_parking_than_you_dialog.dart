...
class BookParkingThanYouDialog extends StatefulWidget {
  final String bookingId;
  final BuildContext parentContext;

  const BookParkingThanYouDialog({
    Key? key,
  ...
  @override
  State<BookParkingThanYouDialog> createState() =>
      _BookParkingThanYouDialogState();
}

class _BookParkingThanYouDialogState extends State<BookParkingThanYouDialog> {
  @override
  void initState() {
