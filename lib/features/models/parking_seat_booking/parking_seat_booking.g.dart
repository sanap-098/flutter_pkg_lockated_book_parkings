...
part of 'parking_seat_booking.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ParkingSeatBookingAdapter extends TypeAdapter<ParkingSeatBooking> {
  @override
  final int typeId = 14;

  @override
  ParkingSeatBooking read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return ParkingSeatBooking(
      id: fields[0] as int?,
      resourceId: fields[1] as int?,
      resourceType: fields[2] as String?,
      userId: fields[3] as int?,
      parkingConfigurationId: fields[4] as int?,
  ...
  @override
  void write(BinaryWriter writer, ParkingSeatBooking obj) {
    writer
      ..writeByte(27)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is ParkingSeatBookingAdapter &&
...
ParkingSeatBooking _$ParkingSeatBookingFromJson(Map<String, dynamic> json) =>
    ParkingSeatBooking(
...
Map<String, dynamic> _$ParkingSeatBookingToJson(ParkingSeatBooking instance) =>
    <String, dynamic>{
      'id': instance.id,
