...
part of 'parking_bookings_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ParkingBookingsModel _$ParkingBookingsModelFromJson(
    ...
    ParkingBookingsModel(
      ...
      showSchedule: json['show_schedule'] == null
          ? null
          : ParkingBookingsShowScheduleModel.fromJson(
              json['show_schedule'] as Map<String, dynamic>),
      qrCodeUrl: json['qr_code_url'] as String?,
      userStatus: json['user_status'] as String?,
      attendance: (json['attendance'] as List<dynamic>?)
          ?.map((e) =>
              ParkingBookingAttendanceModel.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$ParkingBookingsModelToJson(
        ParkingBookingsModel instance) =>
    <String, dynamic>{
      'id': instance.id,
